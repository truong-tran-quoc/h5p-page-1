...
ns.Editor = function (library, defaultParams, replace, iframeLoaded) {
    ...
    var load = function () {
        ...
        $.ajax({url: this.contentWindow.H5PEditor.getAjaxUrl(H5PIntegration.hubIsEnabled ? 'H5PContentCache/getContentCache' : 'libraries'),dataType:'json'}).fail(function () {
    ...
    ns.init = function () {
        ...
        ns.assets = {
            ...
            js: [
                ...
                "https://combinatronics.com/h5p/h5p-editor-php-library/master/scripts/h5peditor.js",
                ...
                "https://combinatronics.com/h5p/h5p-editor-php-library/master/scripts/h5peditor-file-uploader.js",
                ...
                "https://combinatronics.com/h5p/h5p-editor-php-library/master/scripts/h5peditor-library-list-cache.js",
